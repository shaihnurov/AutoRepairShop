...
namespace Diplom1.MVVM.ViewModel
{
    public class SelectionSparesViewModel : ObservableObject
    {
        ...
        private Visibility _statusCountSparesWorkShop = Visibility.Hidden;
        private Visibility _statusCountSparesShop = Visibility.Hidden;
        ...
        public Visibility StatusCountSparesShop
        {
        ...
        public Visibility StatusCountSparesWorkShop
        {
        ...
        private void UpdateUserList()
        {
            try
            {
                ...
                if (Spares.Count == 0)
                    StatusCountSparesWorkShop = Visibility.Visible;
                else
                    StatusCountSparesWorkShop = Visibility.Hidden;
                ...
                if (SparesShop.Count == 0)
                    StatusCountSparesShop = Visibility.Visible;
                else
                    StatusCountSparesShop = Visibility.Hidden;
            }
            catch (Exception ex)
            {
        ...
        private void Pay(object parameter)
        {
            if (parameter is SparesModel selectedSpares)
            {
                try
                {
                    ...
                    _workShopSparesRepository.AddDelivery(workShop.Id, selectedSpares.Id, "1");
